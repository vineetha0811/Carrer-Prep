...
const SECTION_KEY = 'technical';
const CATEGORY = 'technical';
const TITLE = 'Technical Practice';
const SUBTITLE = 'Core subjects, coding concepts & real-world problems.';
const DIFFS = [
  { v: 1, label: 'Basic' },
  ...
  return (
    <div className="mx-auto max-w-3xl space-y-5">
      ...
      <Card className="border-primary-100 bg-primary-50/60">
        <div className="flex items-start gap-3">
          <span className="mt-0.5 flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-primary-600 text-white">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M13 2 4.5 13.5H11L9.5 22 19 10h-6.5z" /></svg>
          </span>
          <div>
            <p className="text-sm font-bold text-slate-900">Adaptive practice</p>
            <p className="mt-0.5 text-xs leading-relaxed text-slate-600">
              Questions adapt to your accuracy — submit answers honestly and the session will surface the topics you need most.
            </p>
          </div>
        </div>
      </Card>
      ...
      {phase === 'empty' && (
        <EmptyState
          icon="🧩"
          title="No practice questions right now"
          subtitle={'We couldn\'t load practice questions. Try again in a moment.'}
